...
- Lausnarglærur ([PDF](https://git.tagl.is/KFFI/keppnir/src/branch/master/ForritunarkeppniFramhaldsskolanna/2026/docs/slides/solution/main_is.pdf))
- Lýsingar, lausnir og prófunartilvik ([Forgejo](https://git.tagl.is/KFFI/keppnir/src/branch/master/ForritunarkeppniFramhaldsskolanna/2026))
- Heildarniðurstöður 
